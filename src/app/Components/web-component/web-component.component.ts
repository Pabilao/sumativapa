...
@Component({
  ...
  standalone: true,
  imports: [Btn1ComponentComponent, Btn2ComponentComponent, Btn3ComponentComponent, Btn4ComponentComponent, Btn5ComponentComponent, ContraComponentComponent, EmailComponentComponent, TextoComponentComponent, ViewComponentComponent, NgModule],
